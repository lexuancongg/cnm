// Loader.jsx (file riêng cho Loader - chỉnh sửa để full-screen overlay với background đen)
...
const FullScreenLoader = styled.div`
  ...
  width: 100vw;
  height: 100vh;
  background-color: rgba(0, 0, 0, 0.8); /* Đen semi-transparent; đổi thành #000 cho full black không trong suốt */
  z-index: 9999; /* Đảm bảo overlay lên trên mọi thứ */
  display: flex;
